        ...
        <div className="relative group">
          ...
          <div className="relative glass rounded-3xl p-10 border border-white/10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    <input
                      ...
                      className="sr-only"
                    />
                    <div className={`px-4 py-4 glass rounded-xl border ${
                      role === 'seeker' 
              ...
              <button
                type="submit"
                className="w-full py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl font-black text-lg hover:shadow-2xl hover:shadow-indigo-500/50 transition-all transform hover:scale-105 btn-shine"
              >
                Sign In
              </button>
            </form>
