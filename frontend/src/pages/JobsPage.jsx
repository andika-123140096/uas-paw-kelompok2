              ...
              <div className="relative glass rounded-3xl p-8 border border-white/10 sticky top-28">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-12 pr-4 py-3 glass border border-white/10 text-white rounded-xl focus:border-indigo-500 focus:outline-none transition-all placeholder:text-gray-600 font-medium"
                        value={searchQuery}
                  ...
                  <div>
                    ...
                    <select
                      className="w-full px-4 py-3 glass border border-white/10 text-white rounded-xl focus:border-indigo-500 focus:outline-none transition-all font-medium"
                      value={typeFilter}
