...
const HomePage = ({
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div
        className="absolute top-40 right-1/4 w-96 h-96 bg-purple-600/20 rounded-full blur-3xl animate-pulse"
        style={{ animationDelay: "1s" }}
      ></div>
      <div
        className="absolute bottom-0 left-1/2 w-96 h-96 bg-pink-600/20 rounded-full blur-3xl animate-pulse"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-24">
        ...
        <div className="text-center mb-16 space-y-8">
          <h1 className="text-7xl md:text-8xl lg:text-9xl font-black text-white leading-none tracking-tight">
            ...
            <span
              className="block text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 animate-slideInRight"
          ...
          <p
            className="text-xl md:text-2xl text-gray-400 max-w-3xl mx-auto leading-relaxed animate-fadeIn font-light"
            style={{ animationDelay: "0.4s" }}
          >
            Join thousands of professionals who found their perfect career
            match. Start your journey today.
          </p>
        </div>

        {/* Search Bar */}
        <div
          className="max-w-4xl mx-auto mb-16 animate-scaleIn"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-32">
          {[
            ...
            >
              <div
                className={`absolute -inset-1 bg-gradient-to-r ${stat.color} rounded-3xl opacity-30 blur-xl group-hover:opacity-50 transition-opacity`}
              ></div>

              <div className="relative glass rounded-3xl p-8 border border-white/10 text-center">
                <div
                  className={`w-16 h-16 bg-gradient-to-br ${stat.color} rounded-2xl flex items-center justify-center mb-6 mx-auto shadow-2xl group-hover:scale-110 transition-transform`}
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                title: "Top Quality",
                description:
                  "All jobs are verified and from reputable companies.",
                color: "from-indigo-500 to-purple-600",
              },
              {
                icon: Award,
                title: "Best Matches",
                description:
                  "AI-powered matching finds your perfect career fit.",
                color: "from-pink-500 to-red-600",
              },
            ].map((feature, index) => (
              <div key={index} className="relative group card-hover">
                <div
                  className={`absolute -inset-1 bg-gradient-to-r ${feature.color} rounded-3xl opacity-20 blur-xl group-hover:opacity-40 transition-opacity`}
                ></div>
